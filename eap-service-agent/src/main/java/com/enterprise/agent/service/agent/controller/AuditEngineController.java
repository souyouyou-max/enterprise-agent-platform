...
import com.enterprise.agent.data.service.AuditEngineService;
import com.enterprise.agent.service.agent.scheduler.AuditEngineScheduler;
 ...
 * 补充 {@link AuditEngineScheduler} 定时触发之外的按需审计能力。
 */
...
public class AuditEngineController {
    ...
    private final AuditEngineScheduler auditEngineScheduler;
    ...
    public ResponseResult<Map<String, Object>> triggerFullAudit(
        ...
        List<ClueResult> clues = auditEngineScheduler.runAuditForOrg(orgCode);

package com.enterprise.agent.app.controller.ops;

import com.enterprise.agent.app.ops.service.PipelineOpsPlaybookService;
...
public class OpsPlaybookController {
    ...
    public static class ChangePlanRequest {
        ...
        private String extraInfo;
        /**
         * 拟变更键值对（如 eap.pipeline.analysis.max-images-per-file -> 1）。
         */

package com.sinosig.aip.app.controller;
...
/**
 * 管理后台：OCR 主表/分片预览。
 * 放在 aip-app 主模块，避免仅运行主类时依赖模块未进 classpath 导致接口未注册（落入静态资源 404）。
 */
@Slf4j
@RestController
...
public class OcrAdminPreviewController {
    ...
    public static class OcrFileSplitPreviewDTO {
        ...
        static OcrFileSplitPreviewDTO from(OcrFileSplit s, boolean includeImageBase64) {
            ...
            dto.setLlmResult(s.getLlmResult());

...
import com.sinosig.aip.business.pipeline.service.OcrPipelineService.PipelineFileInfo;
...
public class SubmitBatchRequest {
    ...
    /** 返回调用方传入的 batchNo，若为空则自动生成。 */
    public String resolveBatchNo() {
    ...
    /** 将请求中的文件列表转换为领域对象列表。 */
    public List<PipelineFileInfo> toFileInfoList() {
        return files.stream()

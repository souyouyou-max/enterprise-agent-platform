...
public class DocumentImageConverter {
    ...
    @Value("${aip.tools.zhengyan.platform.convert.max-pages:20}")
    private int maxPages;

    @Value("${aip.tools.zhengyan.platform.convert.dpi:160}")
    private int dpi;

    @Value("${aip.tools.zhengyan.platform.convert.mode:pure-java}")
    private String mode;

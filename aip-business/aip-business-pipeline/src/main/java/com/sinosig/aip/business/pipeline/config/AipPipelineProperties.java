...
/**
 * OCR 流水线配置（application.yml / Nacos：{@code aip.pipeline}）。
 *
 ...
 */
@Data
@ConfigurationProperties(prefix = "aip.pipeline")
public class AipPipelineProperties {
    ...
    public static class Analysis {
         ...
         * （见 aip-app {@code application.yml} 的 {@code multimodal-prompt-key: ${...}}），绑定到本字段。
         */

package com.enterprise.agent.impl.planner.toolkit;
...
public class PlannerToolkit {
    ...
    @Tool(description = "将用户的高层业务目标拆解为3-5个具体可执行的子任务，返回JSON数组，" +
            "每项包含sequence、description、toolName(getSalesData/getEmployeeInfo/queryCrmData/generateSqlQuery/none)、toolParams字段")

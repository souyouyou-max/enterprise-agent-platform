package com.sinosig.aip.llm.config;
...
/**
 * 根据 aip.llm.provider 配置动态选择 ChatModel。
 * <p>
 ...
 * </ul>
 * 切换方式：修改 aip.llm.provider 配置项，并确保对应的 api-key / base-url 已注入。
 * <p>

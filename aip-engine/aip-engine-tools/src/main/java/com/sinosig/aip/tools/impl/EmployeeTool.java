...
public class EmployeeTool implements EnterpriseTool {
    ...
    private static final Map<String, Object[]> EMPLOYEE_DB = Map.of(
            "E001", new Object[]{"张明", "华南区", "销售总监", "zhang.ming@aip.com", 15, "高级"},
            "E002", new Object[]{"李华", "华北区", "销售经理", "li.hua@aip.com", 8, "中级"},
            "E003", new Object[]{"王芳", "华东区", "区域总监", "wang.fang@aip.com", 12, "高级"},
            "E004", new Object[]{"陈强", "西部区", "销售顾问", "chen.qiang@aip.com", 5, "初级"},
            "E005", new Object[]{"刘洋", "总部", "CTO", "liu.yang@aip.com", 20, "专家"}
    );
